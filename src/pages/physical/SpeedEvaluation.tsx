...
import { SpeedExcelUploader } from "@/components/physical/SpeedExcelUploader";
import { SpeedDataList } from "@/components/physical/SpeedDataList";
...
export default function SpeedEvaluation() {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <main className="flex-1 p-8">
        ...
        <h1 className="text-2xl font-bold mb-4">Evaluación de Velocidad</h1>
        ...
        <div className="bg-white rounded-lg shadow p-6 space-y-8">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <SpeedExcelUploader seasonId={seasonId} categoryId={categoryId} seniorSeasonId={seniorSeasonId} seniorCategoryId={seniorCategoryId} />
              {dateRange && (
