...
import { AnthropometryExcelUploader } from "@/components/physical/AnthropometryExcelUploader";
import { AnthropometryDataList } from "@/components/physical/AnthropometryDataList";
...
export default function AnthropometryEvaluation() {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <main className="flex-1 p-8">
        ...
        <h1 className="text-2xl font-bold mb-4">Evaluación Antropométrica</h1>
        ...
        <div className="bg-white rounded-lg shadow p-6 space-y-8">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <AnthropometryExcelUploader seasonId={seasonId} categoryId={categoryId} seniorSeasonId={seniorSeasonId} seniorCategoryId={seniorCategoryId} />
              {dateRange && (
