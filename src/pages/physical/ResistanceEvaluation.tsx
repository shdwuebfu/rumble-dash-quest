...
import { ResistanceExcelUploader } from "@/components/physical/ResistanceExcelUploader";
import { ResistanceDataList } from "@/components/physical/ResistanceDataList";
...
export default function ResistanceEvaluation() {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <main className="flex-1 p-8">
        ...
        <h1 className="text-2xl font-bold mb-4">Evaluación de Resistencia</h1>
        ...
        <div className="bg-white rounded-lg shadow p-6 space-y-8">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <ResistanceExcelUploader seasonId={seasonId} categoryId={categoryId} seniorSeasonId={seniorSeasonId} seniorCategoryId={seniorCategoryId} />
              {dateRange && (
