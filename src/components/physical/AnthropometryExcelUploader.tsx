...
interface AnthropometryExcelUploaderProps {
  seasonId?: string;
  categoryId?: string;
...
export const AnthropometryExcelUploader = ({
  seasonId,
  categoryId,
  seniorSeasonId,
  seniorCategoryId,
}: AnthropometryExcelUploaderProps) => {
  ...
  const handleSaveDataset = async () => {
    ...
    const { error } = await supabase.from("anthropometry_datasets").insert({
      name: datasetName,
      data: excelData,
    ...
    setDatasetName("");
    queryClient.invalidateQueries({ queryKey: ["anthropometry-datasets"] });
  };
