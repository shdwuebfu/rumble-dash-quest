...
// EXACTAMENTE el mismo código que SpeedDataList.tsx, solo cambiando:
...
interface ResistanceDataListProps {
  dateRange?: DateRange;
  showStats?: boolean;
...
export const ResistanceDataList = ({
  dateRange,
  showStats,
  setShowStats,
  showPlayerStats,
  ...
  const { data: datasets = [], refetch } = useQuery({
    queryKey: ["resistance-datasets", dateRange, seasonId, categoryId, seniorSeasonId, seniorCategoryId],
    queryFn: async () => {
