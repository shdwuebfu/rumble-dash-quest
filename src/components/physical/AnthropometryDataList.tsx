...
interface AnthropometryDataListProps {
  dateRange?: DateRange;
  showStats?: boolean;
...
export const AnthropometryDataList = ({
  dateRange,
  showStats,
  setShowStats,
  showPlayerStats,
  ...
  const { data: datasets = [], refetch } = useQuery({
    queryKey: ["anthropometry-datasets", dateRange, seasonId, categoryId, seniorSeasonId, seniorCategoryId],
    queryFn: async () => {
