-- Migration: fix_player_signup_2025_09_20
...
-- 3) RPC: reutilización de email para jugadores
...
BEGIN
  ...
  IF v_user_id IS NULL THEN
    RETURN jsonb_build_object('success', true, 'create_new_user', true);
  END IF;
  ...
  RETURN jsonb_build_object('success', true, 'reused_account', true);
END;
$$;